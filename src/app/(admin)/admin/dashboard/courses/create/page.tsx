  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-[0_5px_15px_rgba(0,0,0,0.05)] border border-primary-light">
        <div>
          <H1 className="text-3xl font-bold text-primary-dark">Create New Course</H1>
          <p className="text-[#555] mt-1">Fill in the details below to add a new course offering.</p>
        </div>
        <Link 
