...
import GradeWiseCampForm from "../../create/GradeWiseCampForm";
import Breadcrumbs from "@/components/ui/Breadcrumbs";

export default async function EditGradeWiseCampPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!gradeWiseCamp) {
    redirect("/admin/dashboard/grade-wise-camps");
  }
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        <GradeWiseCampForm initialData={gradeWiseCamp} />
      </div>
    </div>
  );
}
