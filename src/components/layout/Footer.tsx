...
export default function Footer() {
  return (
    <footer id="contact" className="bg-primary text-white mt-0 relative z-10 pb-[70px] md:pb-0">
      <div className="w-[90%] max-w-[1300px] mx-auto flex flex-col md:grid md:grid-cols-[1.2fr_1fr_1fr] gap-[30px] md:gap-[50px] py-[40px] md:py-[50px] md:pb-[35px]">
        ...
        <div>
          <div className="mb-[15px] md:mb-[20px]">
            <img src="/images/logo.png" alt="Olympiad Portal Logo" className="w-[80px] md:w-[100px] h-auto block rounded-[18px]" />
          </div>
        ...
        <div>
          ...
          <ul className="list-none m-0 p-0">
            <li className="mb-[8px]">
              <Link href="/" className="text-white no-underline text-[14px] md:text-[15px] transition-all duration-300 hover:pl-[8px] hover:opacity-90">Home</Link>
            </li>
            <li className="mb-[8px]">
      ...
      <div className="text-center py-[15px] md:py-[20px] text-[12px] md:text-[14px] border-t border-white/20">
