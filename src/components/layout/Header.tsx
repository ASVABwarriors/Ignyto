      ...
      <nav className="bg-white flex justify-between items-center py-[8px] md:py-[15px] px-2 md:px-[80px] shadow-[0_-4px_15px_rgba(0,0,0,0.1)] md:shadow-[0_2px_10px_rgba(0,0,0,0.1)] fixed bottom-0 md:sticky md:top-0 left-0 w-full z-[1000] box-border">
        <ul className="list-none flex justify-around md:justify-start w-full gap-[2px] md:gap-[10px] p-0 m-0">
          <li className="flex-1 md:flex-none flex justify-center">
            <Link href="/" className={`flex flex-col md:flex-row items-center justify-center gap-1 text-[#333] text-[11px] md:text-[17px] font-semibold py-[6px] md:py-[10px] px-[5px] md:px-[14px] rounded-[10px] transition-all duration-300 w-full md:w-auto ${pathname === '/' ? 'text-primary md:bg-primary-light md:text-primary font-bold' : 'hover:bg-primary-light hover:text-primary'}`}>
              <FaHome className="text-[22px] md:hidden mb-[2px]" />
              <span>Home</span>
            </Link>
          </li>
          <li className="flex-1 md:flex-none flex justify-center">
            <Link href="/#about" className="flex flex-col md:flex-row items-center justify-center gap-1 text-[#333] text-[11px] md:text-[17px] font-semibold py-[6px] md:py-[10px] px-[5px] md:px-[14px] rounded-[10px] transition-all duration-300 w-full md:w-auto hover:bg-primary-light hover:text-primary">
          ...
          <li className="flex-1 md:flex-none flex justify-center">
            <Link href="#contact" className="flex flex-col md:flex-row items-center justify-center gap-1 text-[#333] text-[11px] md:text-[17px] font-semibold py-[6px] md:py-[10px] px-[5px] md:px-[14px] rounded-[10px] transition-all duration-300 w-full md:w-auto hover:bg-primary-light hover:text-primary">
